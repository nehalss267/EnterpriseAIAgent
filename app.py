...
from langchain_community.document_loaders import PDFPlumberLoader
filename = "EnterpriseAIAgent_knowledgeBase.pdf"
...
def ask_EnterpriseAIAgent(query):
    try:
...
iface = gr.Interface(
    fn=ask_EnterpriseAIAgent,
    inputs=gr.Textbox(
        label="Ask a question",
        placeholder="e.g.What is the conclusion of Paper X"
    ),
    outputs=gr.Textbox(label="Answer"),
    title="EnterpriseAIAgent",
